# Generated by Django 3.2.5 on 2021-09-14 14:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='note_creator', to=settings.AUTH_USER_MODEL)),
                ('innovation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notes', to='innovation.innovation')),
            ],
            options={
                'db_table': 'notes',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outcome', models.CharField(default=None, max_length=100)),
                ('status', models.BooleanField(default=True)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
